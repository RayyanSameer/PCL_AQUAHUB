...
-- Orders table (vendor-customer orders)
CREATE TABLE orders (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE INDEX idx_vendor_trucks_vendor_id ON vendor_trucks(vendor_id);
